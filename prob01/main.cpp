...
int main()
{
  ...
  std::cout << "\nAs both numbers get ever closer to zero, they differ in exact numbers because they are different in amount of bytes." << std::endl;
  std::cout << sizeof(d2) << " bytes, value: " << d2 << std::endl;
  std::cout << sizeof(f2) << " bytes, value: " << f2 << std::endl;
  ...
  std::cout << "\nWhen both numbers grow further from zero, they still are different due to lack of accuracy." << std::endl;
  std::cout << sizeof(d2) << " bytes, value: " << d2 << std::endl;
  std::cout << sizeof(f2) << " bytes, value: " << f2 << std::endl;
  ...
  std::cout << "\nf3 is infinite because of not being exact and having overflow." << std::endl;
